...
#define TYPE_KER_EMV			1
#define TYPE_KER_PBOC			2
#define TYPE_KER_PAYWAVE		3
#define TYPE_KER_QPBOC			4
#define TYPE_KER_AMEX			5
#define TYPE_KER_DPAS			6
#define TYPE_KER_PAYPASS		7
#define TYPE_KER_JSPEEDY		8
#define TYPE_KER_MIR			9
